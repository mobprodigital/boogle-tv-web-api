...
if($_SERVER["REQUEST_METHOD"] == "POST")
{
	...
	else
	{
		...
		$check_query = "select * from contents where id=$videoId";
		...
		if(mysqli_num_rows($check_query_rs) > 0)
		{
			...
			{
				$updatedata = "update contents set cover_image ='$filename',content_url='$vidfilename',content_length='$videoLength',extension='$extension',mime='$videoMime' where id = $videoId";
