...
if($_SERVER["REQUEST_METHOD"] == "POST")
{
	...
	wh_log("videoId - ".$videoId." | clientID - ".$clientId." | Title - ".$title." | Language - ".$language." | Description -".$description." | minAgeReq -".$minAgeReq." | broadcasterName -".$broadcasterName." | type -".$type." | currentAvailability -".$currentAvailability." | platform -".$platform." | adult -".$adult." | downloadRights -".$downloadRights." | internationalRights -".$internationalRights." | genere -".$genere." | director -".$director." | producer -".$producer." | writer -".$writer." | musicDirector -".$musicDirector." | productionHouse -".$productionHouse." | actor -".$actor." | singer -".$singer." | videoLength - ".$videoLength." | extension -".$extension." | videoMime - ".$videoMime);
